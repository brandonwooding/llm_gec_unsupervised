...
if __name__ == "__main__":
    ...
    if n_essays != 0:
        ...
        if n_essays < 10:
            logger.warning("A very small number of essays was loaded. If this was intended, you can ignore this warning. Otherwise, make sure that both your dataset and the dataloader work as expected.")
    else:
