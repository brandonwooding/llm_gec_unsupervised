# Write & Improve Corpus 2024 local GLEU & ERRANT scoring

This package is adapted from the code released for local scoring of hypothesis files for the MultiGEC-2025 shared task, using a modified version of ERRANT to obtain precision, recall and F0.5 scores. It will also output GLEU scores using the implementation by [Shota Koyama](https://github.com/shotakoyama/gleu)
